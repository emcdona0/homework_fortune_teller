class ZodiacsController < ApplicationController
  ...
  def sign
    #@sign_temp = params[:the_sign]
    #Filtering Zodiac by whatever the user types in
    @zodiac_all = Zodiac.find_by({:sign => params[:the_sign]})
  ...
  def creature
    #@sign_temp = params[:the_sign]
    #Filtering Zodiac by whatever the user types in
    @zodiac_all = Zodiac.find_by({:creature => params[:the_creature]})
